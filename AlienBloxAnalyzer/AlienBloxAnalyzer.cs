...
namespace AlienBloxAnalyzer
{
    ...
    public class AlienBloxAnalyzer : DiagnosticAnalyzer
    {
        ...
        private void AnalyzeMemberAccess(SyntaxNodeAnalysisContext context)
        {
            ...
            if (memberAccess.Name.Identifier.Text != "LuaUnifiedEnv")
                return;
            ...
            if (containingType.Name != "AlienBloxUtility") return; // restrict to your type

            // Report a diagnostic
            var diagnostic = Diagnostic.Create(Rule, memberAccess.GetLocation(), "LuaUnifiedEnv", "RegisterFunc");
